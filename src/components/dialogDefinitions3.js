...
export function getDialogDefinitions(){
    ...
    const getDialogFields = function(dialogDef, dialogPage){
        debugger;
        var currentDefs = defs(dialogDef);
        return currentDefs.dialogFields[dialogPage];
    }
    const getDefaultData = function(dialogDef){
        var currentDefs = defs(dialogDef);
        return currentDefs.defaultData;
    }
    const getDialogSequence = function(dialogDef){
        var currentDefs = defs(dialogDef);
        return currentDefs.dialogSequence;
    }
    return {getDialogAppearence, getDialogFields, getDefaultData, getDialogSequence}
}
/*
const existingData = {
    name: "Curious George",
...
const defs = function(dialogDef, dialogPaqge){
    switch(dialogDef){
        case 'testDialog':{
            return {
                dialogAppearence: {
